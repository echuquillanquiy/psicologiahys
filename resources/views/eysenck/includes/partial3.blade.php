<div class="col-lg-4 col-md-4 col-sm-12">
    <div class="row">
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="39" value="{{ old('39') }}">
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="40" value="{{ old('40') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="41" value="{{ old('41') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="42" value="{{ old('42') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="43" value="{{ old('43') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="44" value="{{ old('44') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="45" value="{{ old('45') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="46" value="{{ old('46') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="47" value="{{ old('47') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="48" value="{{ old('48') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="49" value="{{ old('49') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="50" value="{{ old('50') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="51" value="{{ old('51') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="52" value="{{ old('52') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="53" value="{{ old('53') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="54" value="{{ old('54') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="55" value="{{ old('55') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="56" value="{{ old('56') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
        ...
        <div class="col-sm-2 mb-1">
            <select class="form-select" aria-label="Default select example" name="57" value="{{ old('57') }}">
                <option value="">Elija</option>
                <option value="1">SI</option>
                <option value="0">NO</option>
            </select>
